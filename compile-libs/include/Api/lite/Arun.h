...
extern long long SPECIALARR_LEN;												// 06/09/00 AM.
...
//	static bool micro_feat(NODE *,const ELT *,Nlppp *);			// 05/25/00 AM.
   ...
   // For dejunk matching.       // 09/09/11 AM.
	...
	static bool singler(Nlppp *,long long,long long);							// 06/02/00 AM.
	static bool singlex(Nlppp *,long long,long long);							// 06/02/00 AM.
	static bool	singlezap(Nlppp *);										// 01/04/01 AM.
	static bool merge(Nlppp *);											// 06/02/00 AM.
	static bool merger(Nlppp *,long long,long long);								// 06/02/00 AM.
	static bool listadd(Nlppp *,long long,long long,_TCHAR * =_T("false"));		// 06/02/00 AM.
	static bool listaddleft(Nlppp *,long long,long long,long long = 0);			// 06/02/00 AM.
	...
	static bool splice(Nlppp *, long long,long long);							// 06/02/00 AM.
	static bool setbase(Nlppp *,long long,_TCHAR *);							// 06/02/00 AM.
	static bool setunsealed(Nlppp *,long long,_TCHAR *);					// 06/02/00 AM.
	static bool post_final(Nlppp *);

	// Selected post actions.												// 06/02/00 AM.
	static bool addstrs(Nlppp *,_TCHAR *,long long);							// 06/02/00 AM.
	static bool print(Nlppp *, _TCHAR *);									// 06/02/00 AM.
	static bool printr(Nlppp *, long long,long long);							// 06/02/00 AM.
	static bool prlit(Nlppp *, _TCHAR *, _TCHAR *);						// 06/02/00 AM.
	static bool prrange(Nlppp *,_TCHAR *,long long,long long);					// 06/02/00 AM.
	static bool prchild(Nlppp *,_TCHAR *,long long,_TCHAR *);				// 06/02/00 AM.
	static bool prtree(Nlppp *,_TCHAR *,long long,_TCHAR *);					// 06/02/00 AM.
	static bool prxtree(Nlppp*,_TCHAR*,_TCHAR*,long long,_TCHAR*,_TCHAR*);	// 06/02/00 AM.
	static bool ndump(Nlppp*,_TCHAR*,long long=0);							// 06/02/00 AM.
	static bool xdump(Nlppp*,_TCHAR*,long long=0);							// 06/02/00 AM.
	...
	static bool lengthr(Nlppp *,long long,long long);							// 06/02/00 AM.
	...
	// NLP++
	static RFASem *n(_TCHAR*,int,long long,bool,Nlppp*);
	static RFASem *x(_TCHAR*,int,long long,bool,Nlppp*);
	static RFASem *s(_TCHAR*,long long,bool,Nlppp*);
	static RFASem *g(_TCHAR*,long long,bool,Nlppp*);
	static RFASem *l(_TCHAR*,long long,bool,Nlppp*);							// 03/09/02 AM.
	...
	static RFASem *assign(int,_TCHAR*,int,long long,Nlppp*,RFASem*);
	static long long    assign(int,_TCHAR*,int,long long,Nlppp*,long long);
	static float   assign(int,_TCHAR*,int,long long,Nlppp*,float);
	...
	static long long    iassign(int,_TCHAR*,int,long long,Nlppp*,long long);
	static float   iassign(int,_TCHAR*,int,long long,Nlppp*,float);
	...
	static long long conf(RFASem *, long long);
	static long long conf(RFASem *, RFASem *);
	static long long conf(long long, long long);
	static long long conf(long long, RFASem *);

	// Note: Should really return bool type....not in NLP++ yet.
	static long long eq(RFASem*,long long);
	static long long eq(RFASem*,float);
	static long long eq(RFASem *, RFASem *);
	static long long eq(RFASem *, _TCHAR *);
	static long long eq(long long, long long);
	static long long eq(long long,RFASem*);
	static long long eq(float,RFASem*);
	static long long eq(_TCHAR *, _TCHAR *);
	static long long eq(_TCHAR *, RFASem *);
	static long long eq(long long,float);
	static long long eq(float,long long);
	static long long eq(float,float);
	static long long eq(_TCHAR*,long long);                  // 07/11/03 AM.
	static long long eq(long long,_TCHAR*);                  // 07/11/03 AM.


	static long long ne(RFASem*,long long);
	static long long ne(RFASem*,float);
	static long long ne(RFASem *, RFASem *);
	static long long ne(long long, long long);
	static long long ne(long long, RFASem *);
	static long long ne(float,RFASem*);
	static bool ne(_TCHAR *, _TCHAR *);
	static bool ne(_TCHAR *, RFASem *);
	static bool ne(RFASem *, _TCHAR *);
	static long long ne(float,long long);
	static long long ne(long long,float);
	static long long ne(float,float);
	static long long ne(_TCHAR*,long long);                  // 07/11/03 AM.
	static long long ne(long long,_TCHAR*);                  // 07/11/03 AM.

	static long long gt(RFASem *, long long);
	static long long gt(RFASem *, float);
	static long long gt(RFASem *, RFASem *);
	static long long gt(long long, long long);
	static long long gt(long long, RFASem *);
	static long long gt(float, RFASem*);
	static long long gt(float,long long);
	static long long gt(long long,float);
	static long long gt(float,float);

	static long long lt(RFASem *, long long);
	static long long lt(RFASem*,float);
	static long long lt(RFASem *, RFASem *);
	static long long lt(long long, long long);
	static long long lt(long long, RFASem *);
	static long long lt(float,RFASem*);
	static long long lt(float,long long);
	static long long lt(long long,float);
	static long long lt(float,float);

	static long long ge(RFASem *, long long);
	static long long ge(RFASem*,float);
	static long long ge(RFASem *, RFASem *);
	static long long ge(long long, long long);
	static long long ge(long long, RFASem *);
	static long long ge(float,RFASem*);
	static long long ge(float,long long);
	static long long ge(long long,float);
	static long long ge(float,float);

	static long long le(RFASem *, long long);
	static long long le(RFASem*,float);
	static long long le(RFASem *, RFASem *);
	static long long le(long long, long long);
	static long long le(long long, RFASem *);
	static long long le(float,RFASem*);
    static long long le(float,long long);
	static long long le(long long,float);
	static long long le(float,float);

	static long long vtand(RFASem *, long long);
	static long long vtand(RFASem*,float);
	static long long vtand(RFASem *, RFASem *);
	static long long vtand(RFASem *, _TCHAR *);									// 06/11/00 AM.
	static bool vtand(RFASem*,bool);										// 09/03/01 AM.
	static long long vtand(long long, long long);
	static long long vtand(long long, RFASem *);
	static long long vtand(long long, _TCHAR *);										// 06/11/00 AM.
	static long long vtand(long long,float);
	static bool vtand(long long,bool);											// 09/03/01 AM.
	static long long vtand(float,RFASem*);
	static long long vtand(float,_TCHAR*);
	static long long vtand(float,long long);
	static long long vtand(float,float);
	static bool vtand(float,bool);											// 09/03/01 AM.
	static long long vtand(_TCHAR *, RFASem *);									// 06/11/00 AM.
	static long long vtand(_TCHAR *, long long);										// 06/11/00 AM.
	static long long vtand(_TCHAR*,float);
	static long long vtand(_TCHAR *, _TCHAR *);										// 06/11/00 AM.
	...
	static long long vtor(RFASem *, long long);
	static long long vtor(RFASem *, float);
	static long long vtor(RFASem *, RFASem *);
	static long long vtor(RFASem *, _TCHAR *);									// 06/11/00 AM.
	static bool vtor(RFASem*,bool);											// 09/03/01 AM.
	static long long vtor(long long, long long);
	static long long vtor(long long,float);
	static long long vtor(long long, RFASem *);
	static long long vtor(long long, _TCHAR *);											// 06/11/00 AM.
	static bool vtor(long long,bool);												// 09/03/01 AM.
	static long long vtor(float,long long);
	static long long vtor(float,float);
	static long long vtor(float, RFASem *);
	static long long vtor(float, _TCHAR*);
	static bool vtor(float,bool);											// 09/03/01 AM.
	static long long vtor(_TCHAR*, RFASem *);										// 06/11/00 AM.
	static long long vtor(_TCHAR*, long long);											// 06/11/00 AM.
	static long long vtor(_TCHAR*,float);
	static long long vtor(_TCHAR*, _TCHAR *);										// 06/11/00 AM.
   ...
   static RFASem *vtcout(Nlppp*);                                 // 05/06/09 AM.
	...
	static long long vtnot(long long);
	static long long vtnot(float);
	static long long vtnot(RFASem *);
	static long long vtnot(_TCHAR *);
	...
	static long long phraselength(Nlppp*, RFASem*);
	...
	static RFASem *findnode(Nlppp*,RFASem*,long long);
	...
	static RFASem *addnode(Nlppp*,RFASem*,_TCHAR*,long long);
	static RFASem *addnode(Nlppp*,RFASem*,RFASem*,long long);			// 05/06/01 AM.
	...
	static bool renamenode(Nlppp*,RFASem*,long long,_TCHAR*);
	static bool renamenode(Nlppp*,RFASem*,_TCHAR*,RFASem*);			// 05/06/01 AM.
	static bool renamenode(Nlppp*,RFASem*,long long,RFASem*);			// 05/06/01 AM.
	...
	static bool strcontains(Nlppp*,long long,RFASem*);               // 07/11/03 AM.
	static bool strcontains(Nlppp*,RFASem*,long long);               // 07/11/03 AM.
	static bool strcontains(Nlppp*,long long,_TCHAR*);                 // 07/11/03 AM.
	static bool strcontains(Nlppp*,_TCHAR*,long long);                 // 07/11/03 AM.
	static bool strcontains(Nlppp*,long long,long long);		            // 07/11/03 AM.
	...
	static bool strcontainsnocase(Nlppp*,long long,long long);            // 07/11/03 AM.
	static bool strcontainsnocase(Nlppp*,long long,_TCHAR*);           // 07/11/03 AM.
	static bool strcontainsnocase(Nlppp*,_TCHAR*,long long);           // 07/11/03 AM.
	static bool strcontainsnocase(Nlppp*,long long,RFASem*);         // 07/11/03 AM.
	static bool strcontainsnocase(Nlppp*,RFASem*,long long);         // 07/11/03 AM.
	...
	static bool strequal(Nlppp*,RFASem*,long long);                  // 07/11/03 AM.
	static bool strequal(Nlppp*,long long,RFASem*);                  // 07/11/03 AM.
	static bool strequal(Nlppp*,_TCHAR*,long long);                    // 07/11/03 AM.
	static bool strequal(Nlppp*,long long,_TCHAR*);                    // 07/11/03 AM.
	static bool strequal(Nlppp*,long long,long long);                     // 07/11/03 AM.
	...
	static bool strnotequal(Nlppp*,long long,long long);                  // 07/11/03 AM.
	static bool strnotequal(Nlppp*,long long,_TCHAR*);                 // 07/11/03 AM.
	static bool strnotequal(Nlppp*,_TCHAR*,long long);                 // 07/11/03 AM.
	static bool strnotequal(Nlppp*,long long,RFASem*);               // 07/11/03 AM.
	static bool strnotequal(Nlppp*,RFASem*,long long);               // 07/11/03 AM.
	...
	static bool strequalnocase(Nlppp*,RFASem*,long long);            // 07/11/03 AM.
	static bool strequalnocase(Nlppp*,long long,RFASem*);            // 07/11/03 AM.
	static bool strequalnocase(Nlppp*,_TCHAR*,long long);              // 07/11/03 AM.
	static bool strequalnocase(Nlppp*,long long,_TCHAR*);              // 07/11/03 AM.
	static bool strequalnocase(Nlppp*,long long,long long);               // 07/11/03 AM.
	...
	static bool strnotequalnocase(Nlppp*,RFASem*,long long);         // 07/11/03 AM.
	static bool strnotequalnocase(Nlppp*,long long,RFASem*);         // 07/11/03 AM.
	static bool strnotequalnocase(Nlppp*,_TCHAR*,long long);           // 07/11/03 AM.
	static bool strnotequalnocase(Nlppp*,long long,_TCHAR*);           // 07/11/03 AM.
	static bool strnotequalnocase(Nlppp*,long long,long long);            // 07/11/03 AM.
	...
	static bool strgreaterthan(Nlppp*,long long,long long);               // 07/11/03 AM.
	static bool strgreaterthan(Nlppp*,long long,_TCHAR*);              // 07/11/03 AM.
	static bool strgreaterthan(Nlppp*,_TCHAR*,long long);              // 07/11/03 AM.
	static bool strgreaterthan(Nlppp*,long long,RFASem*);            // 07/11/03 AM.
	static bool strgreaterthan(Nlppp*,RFASem*,long long);            // 07/11/03 AM.
	...
	static bool strlessthan(Nlppp*,long long,long long);                  // 07/11/03 AM.
	static bool strlessthan(Nlppp*,long long,_TCHAR*);                 // 07/11/03 AM.
	static bool strlessthan(Nlppp*,_TCHAR*,long long);                 // 07/11/03 AM.
	static bool strlessthan(Nlppp*,long long,RFASem*);               // 07/11/03 AM.
	static bool strlessthan(Nlppp*,RFASem*,long long);               // 07/11/03 AM.
	...
	static _TCHAR *strtolower(Nlppp*,long long);                       // 07/11/03 AM.

	static _TCHAR *strtoupper(Nlppp*,_TCHAR*);
	static _TCHAR *strtoupper(Nlppp*,RFASem*);							// 05/06/01 AM.
	static _TCHAR *strtoupper(Nlppp*,long long);                       // 07/11/03 AM.

	static RFASem *addword(Nlppp*,_TCHAR*);
	static RFASem *addword(Nlppp*,RFASem*);							// 05/05/01 AM.

	static long long strlength(Nlppp*,_TCHAR*);
	static long long strlength(Nlppp*,RFASem*);								// 01/23/01 AM.
	static long long strlength(Nlppp*,long long);                         // 07/11/03 AM.

	// long long params widened to long long so that the generator-emitted `(long long)0` is an
	// exact match, instead of an NPC-ambiguous conversion against the RFASem* overloads.
	static _TCHAR *strpiece(Nlppp*,_TCHAR*,long long,long long);
	static _TCHAR *strpiece(Nlppp*,RFASem*,long long,long long);				// 05/06/01 AM.
	static _TCHAR *strpiece(Nlppp*,_TCHAR*,RFASem*,long long);				// 05/06/01 AM.
	static _TCHAR *strpiece(Nlppp*,_TCHAR*,long long,RFASem*);				// 05/06/01 AM.
	static _TCHAR *strpiece(Nlppp*,RFASem*,RFASem*,long long);			// 05/06/01 AM.
	static _TCHAR *strpiece(Nlppp*,RFASem*,long long,RFASem*);			// 05/06/01 AM.
	...
	static _TCHAR *strpiece(Nlppp*,long long,long long,long long);               // 07/11/03 AM.
	static _TCHAR *strpiece(Nlppp*,long long,RFASem*,long long);            // 07/11/03 AM.
	static _TCHAR *strpiece(Nlppp*,long long,long long,RFASem*);            // 07/11/03 AM.
	static _TCHAR *strpiece(Nlppp*,long long,RFASem*,RFASem*);         // 07/11/03 AM.

	static _TCHAR *strchar(Nlppp*,_TCHAR*,long long);
	static _TCHAR *strchar(Nlppp*,RFASem*,long long);						// 05/06/01 AM.
	static _TCHAR *strchar(Nlppp*,_TCHAR*,RFASem*);						// 05/06/01 AM.
	static _TCHAR *strchar(Nlppp*,RFASem*,RFASem*);					// 05/06/01 AM.
	static _TCHAR *strchar(Nlppp*,long long,long long);                     // 07/11/03 AM.
	static _TCHAR *strchar(Nlppp*,long long,RFASem*);                  // 07/11/03 AM.

	static bool strisdigit(Nlppp*,_TCHAR*);
	static bool strisdigit(Nlppp*,RFASem*);							// 05/07/01 AM.
	static bool strisdigit(Nlppp*,long long);                        // 07/11/03 AM.

	static bool strisalpha(Nlppp*,_TCHAR*);
	static bool strisalpha(Nlppp*,RFASem*);							// 05/07/01 AM.
	static bool strisalpha(Nlppp*,long long);                        // 07/11/03 AM.

	static bool strhaspunct(Nlppp*,_TCHAR*);
	static bool strhaspunct(Nlppp*,RFASem*);
	static bool strhaspunct(Nlppp*,long long);
...
//////////////
	...
	static bool xrename(Nlppp*,_TCHAR*, long long=0);
	static bool xrename(Nlppp*,RFASem*, long long=0);						// 05/07/01 AM.
...
//////////////
	...
	static long long  arraylength(Nlppp*,_TCHAR*);								// 01/04/01 AM.
	static long long  arraylength(Nlppp*,long long);								// 01/04/01 AM.
	static long long  arraylength(Nlppp*,RFASem*);							// 01/04/01 AM.

	static RFASem *lasteltnode(Nlppp*,long long);							// 01/04/01 AM.
	static RFASem *lasteltnode(Nlppp*,RFASem*);						// 01/04/01 AM.
	static RFASem *eltnode(Nlppp*,long long);                        // 09/12/06 AM.
	...
	static RFASem *varinlist(Nlppp*,_TCHAR*,long long);						// 01/08/01 AM.
	static RFASem *varinlist(Nlppp*,RFASem*,long long);					// 05/07/01 AM.
	...
	static RFASem *unpackdirs(Nlppp*,long long);                     // 07/11/03 AM.
	...
	static long long strchrcount(Nlppp*,_TCHAR*,_TCHAR*);						// 12/15/02 AM.
	static long long strchrcount(Nlppp*,_TCHAR*,RFASem*);					// 12/15/02 AM.
	static long long strchrcount(Nlppp*,RFASem*,_TCHAR*);					// 12/15/02 AM.
	static long long strchrcount(Nlppp*,RFASem*,RFASem*);				// 12/15/02 AM.
	...
	static _TCHAR *strwrap(Nlppp*,_TCHAR*,long long);							// 01/09/01 AM.
	static _TCHAR *strwrap(Nlppp*,RFASem*,long long);						// 05/07/01 AM.
	...
	static _TCHAR *strsubst(Nlppp*,_TCHAR*,_TCHAR*,long long);          // 07/12/08 AM.
	static _TCHAR *strsubst(Nlppp*,RFASem*,_TCHAR*,long long);          // 07/12/08 AM.
	static _TCHAR *strsubst(Nlppp*,_TCHAR*,RFASem*,long long);          // 07/12/08 AM.
	static _TCHAR *strsubst(Nlppp*,RFASem*,RFASem*,long long);          // 07/12/08 AM.
   ...
   // strspellcompare: Return long long NOT int, conform w Arun fns. // 08/09/11 AM.
	static long long strspellcompare(Nlppp*,_TCHAR*,_TCHAR*);         // 01/09/01 AM.
	static long long strspellcompare(Nlppp*,RFASem*,_TCHAR*);         // 05/07/01 AM.
	static long long strspellcompare(Nlppp*,_TCHAR*,RFASem*);         // 05/07/01 AM.
	static long long strspellcompare(Nlppp*,RFASem*,RFASem*);         // 05/07/01 AM.

	static _TCHAR *spellcandidates(Nlppp*,_TCHAR*);						// 01/09/01 AM.
	static _TCHAR *spellcandidates(Nlppp*,RFASem*);					// 05/07/01 AM.
	static _TCHAR *spellcandidates(Nlppp*,long long);                  // 07/11/03 AM.

	static bool spellword(Nlppp*,_TCHAR*);								// 01/09/01 AM.
	static bool spellword(Nlppp*,RFASem*);								// 01/23/01 AM.
	static bool spellword(Nlppp*,long long);                         // 07/11/03 AM.

	static _TCHAR *spellcorrect(Nlppp*,_TCHAR*);							// 01/09/01 AM.
	static _TCHAR *spellcorrect(Nlppp*,RFASem*);						// 05/07/01 AM.
	static _TCHAR *spellcorrect(Nlppp*,long long);                     // 07/11/03 AM.

	static _TCHAR *lj(Nlppp*,_TCHAR*,long long);									// 01/09/01 AM.
	static _TCHAR *lj(Nlppp*,RFASem*,long long);								// 01/23/01 AM.
	...
	static _TCHAR *rightjustifynum(Nlppp*,long long,long long);					// 01/09/01 AM.
	static _TCHAR *rightjustifynum(Nlppp*,RFASem*,long long);				// 01/23/01 AM.
	static _TCHAR *rightjustifynum(Nlppp*,long long,RFASem*);				// 05/07/01 AM.
	static _TCHAR *rightjustifynum(Nlppp*,RFASem*,RFASem*);			// 05/07/01 AM.

	static _TCHAR *percentstr(Nlppp*,long long,long long);						// 01/09/01 AM.
	static _TCHAR *percentstr(Nlppp*,RFASem*,long long);					// 05/07/01 AM.
	static _TCHAR *percentstr(Nlppp*,long long,RFASem*);					// 05/07/01 AM.
	static _TCHAR *percentstr(Nlppp*,RFASem*,RFASem*);				// 05/07/01 AM.

	static long long hitconf(Nlppp*,long long,long long,long long);						// 01/09/01 AM.
	static long long hitconf(Nlppp*,RFASem*,long long,long long);					// 05/07/01 AM.
	static long long hitconf(Nlppp*,long long,RFASem*,long long);					// 05/07/01 AM.
	static long long hitconf(Nlppp*,long long,long long,RFASem*);					// 05/07/01 AM.
	static long long hitconf(Nlppp*,RFASem*,RFASem*,long long);				// 05/07/01 AM.
	static long long hitconf(Nlppp*,RFASem*,long long,RFASem*);				// 05/07/01 AM.
	static long long hitconf(Nlppp*,long long,RFASem*,RFASem*);				// 05/07/01 AM.
	static long long hitconf(Nlppp*,RFASem*,RFASem*,RFASem*);			// 05/07/01 AM.
	...
	static bool pncopyvars(Nlppp*,long long);								// 05/16/01 AM.
	...
	static bool strisupper(Nlppp*,long long);                        // 07/11/03 AM.
	static bool strislower(Nlppp*,long long);                        // 07/11/03 AM.
	...
	static long long levenshtein(Nlppp*,_TCHAR*,_TCHAR*);         // 03/06/07 AM.
	static long long levenshtein(Nlppp*,_TCHAR*,RFASem*);         // 03/06/07 AM.
	static long long levenshtein(Nlppp*,RFASem*,_TCHAR*);         // 03/06/07 AM.
	static long long levenshtein(Nlppp*,RFASem*,RFASem*);         // 03/06/07 AM.
	static long long levenshtein(Nlppp*,long long,long long);               // 03/06/07 AM.
	static long long levenshtein(Nlppp*,long long,_TCHAR*);            // 03/06/07 AM.
	static long long levenshtein(Nlppp*,_TCHAR*,long long);            // 03/06/07 AM.
	static long long levenshtein(Nlppp*,long long,RFASem*);            // 03/06/07 AM.
	static long long levenshtein(Nlppp*,RFASem*,long long);            // 03/06/07 AM.
	...
	static long long excepth(Nlppp*,void*,void*,int);                // 03/09/14 AM.
	...
	static RFASem *pninsert(Nlppp*,_TCHAR*,NODE*,long long);         // 07/14/08 AM.
	static RFASem *pninsert(Nlppp*,RFASem*,NODE*,long long);         // 07/14/08 AM.
	static RFASem *pninsert(Nlppp*,_TCHAR*,NODE*,RFASem*);      // 07/14/08 AM.
	static RFASem *pninsert(Nlppp*,RFASem*,NODE*,RFASem*);      // 07/14/08 AM.
	static RFASem *pninsert(Nlppp*,_TCHAR*,RFASem*,long long);       // 07/14/08 AM.
	static RFASem *pninsert(Nlppp*,RFASem*,RFASem*,long long);       // 07/14/08 AM.
	...
	static RFASem *pnmove(Nlppp*,NODE*,NODE*,long long);           // 10/06/13 AM.
	static RFASem *pnmove(Nlppp*,RFASem*,NODE*,long long);         // 10/06/13 AM.
	static RFASem *pnmove(Nlppp*,NODE*,NODE*,RFASem*);        // 10/06/13 AM.
	static RFASem *pnmove(Nlppp*,RFASem*,NODE*,RFASem*);      // 10/06/13 AM.
	static RFASem *pnmove(Nlppp*,NODE*,RFASem*,long long);         // 10/06/13 AM.
	static RFASem *pnmove(Nlppp*,RFASem*,RFASem*,long long);       // 10/06/13 AM.
	...
	static bool dbbindcol_int(Nlppp*,long long,_TCHAR*,long long,RFASem*,RFASem*);
	static bool dbbindcol(Nlppp*,long long,_TCHAR*,long long,RFASem*,RFASem*);
	static bool dbbindcol(Nlppp*,RFASem*,_TCHAR*,long long,RFASem*,RFASem*);
	static bool dbbindcol(Nlppp*,long long,RFASem*,long long,RFASem*,RFASem*);
	static bool dbbindcol(Nlppp*,long long,_TCHAR*,RFASem*,RFASem*,RFASem*);
	static bool dbbindcol(Nlppp*,RFASem*,RFASem*,long long,RFASem*,RFASem*);
	static bool dbbindcol(Nlppp*,RFASem*,_TCHAR*,RFASem*,RFASem*,RFASem*);
	static bool dbbindcol(Nlppp*,long long,RFASem*,RFASem*,RFASem*,RFASem*);
	...
	static RFASem *sortconsbyattr(										// 12/14/02 AM.
									Nlppp*,RFASem*,_TCHAR*,long long,long long);		// 12/14/02 AM.
	static RFASem *sortconsbyattr(										// 12/14/02 AM.
									Nlppp*,RFASem*,RFASem*,long long,long long);	// 12/14/02 AM.

	// Get substring of the input text.									// 12/15/02 AM.
	static _TCHAR *inputrange(Nlppp*,long long,long long);						// 12/15/02 AM.
	static _TCHAR *inputrange(Nlppp*,RFASem*,long long);					// 12/15/02 AM.
	static _TCHAR *inputrange(Nlppp*,long long,RFASem*);					// 12/15/02 AM.
	...
	static bool inputrangetofile(Nlppp*,long long,RFASem*,RFASem*);
	static bool inputrangetofile(Nlppp*,RFASem*,long long,std::_t_ostream*);
	static bool inputrangetofile(Nlppp*,RFASem*,long long,RFASem*);
	...
	static _TCHAR *resolveurl(Nlppp*,long long,long long);                  // 07/11/03 AM.
	static _TCHAR *resolveurl(Nlppp*,long long,_TCHAR*);                 // 07/11/03 AM.
	static _TCHAR *resolveurl(Nlppp*,_TCHAR*,long long);                 // 07/11/03 AM.
	static _TCHAR *resolveurl(Nlppp*,long long,RFASem*);               // 07/11/03 AM.
	static _TCHAR *resolveurl(Nlppp*,RFASem*,long long);               // 07/11/03 AM.
	...
	static RFASem *split(Nlppp*,long long,long long);                     // 08/14/03 AM.
	static RFASem *split(Nlppp*,long long,_TCHAR*);                    // 08/14/03 AM.
	static RFASem *split(Nlppp*,_TCHAR*,long long);                    // 08/14/03 AM.
	static RFASem *split(Nlppp*,long long,RFASem*);                  // 08/14/03 AM.
	static RFASem *split(Nlppp*,RFASem*,long long);                  // 08/14/03 AM.

	static _TCHAR *deaccent(Nlppp*,_TCHAR*);								// 09/07/03 AM.
	static _TCHAR *deaccent(Nlppp*,RFASem*);								// 09/07/03 AM.
	static _TCHAR *deaccent(Nlppp*,long long);                         // 09/07/03 AM.

	static _TCHAR *dejunk(Nlppp*,_TCHAR*);   // 09/09/11 AM.
	static _TCHAR *dejunk(Nlppp*,RFASem*);   // 09/09/11 AM.
	static _TCHAR *dejunk(Nlppp*,long long);      // 09/09/11 AM.

	static bool lextagger(Nlppp*);                              // 12/14/03 AM.

	static bool setlookahead(Nlppp*,RFASem*);                   // 12/14/03 AM.
	static bool setlookahead(Nlppp*,long long);                      // 12/14/03 AM.

	static RFASem *permuten(Nlppp*,RFASem*);							// 03/10/04 AM.
	static RFASem *permuten(Nlppp*,long long);								// 03/10/04 AM.
   ...
   static float logten(Nlppp*,float);                          // 04/29/04 AM.
	...
	static _TCHAR *urltofile(Nlppp*,RFASem*,long long);    // 05/14/14 AM.
	static _TCHAR *urltofile(Nlppp*,long long,RFASem*);    // 05/14/14 AM.
	static _TCHAR *urltofile(Nlppp*,_TCHAR*,long long);    // 05/14/14 AM.
	static _TCHAR *urltofile(Nlppp*,long long,_TCHAR*);    // 05/14/14 AM.
	static _TCHAR *urltofile(Nlppp*,long long,long long);       // 05/14/14 AM.
	...
	////
	static bool DICTphraselookup(Nlppp*,NODE*,_TCHAR*,_TCHAR*,_TCHAR*,long long);      // 12/16/14 AM.
	
	static bool DICTphraselookup(Nlppp*,RFASem*,_TCHAR*,_TCHAR*,_TCHAR*,long long);    // 12/16/14 AM.
	static bool DICTphraselookup(Nlppp*,NODE*,RFASem*,_TCHAR*,_TCHAR*,long long);      // 12/16/14 AM.
	static bool DICTphraselookup(Nlppp*,NODE*,_TCHAR*,RFASem*,_TCHAR*,long long);      // 12/16/14 AM.
	static bool DICTphraselookup(Nlppp*,NODE*,_TCHAR*,_TCHAR*,RFASem*,long long);      // 12/16/14 AM.
	static bool DICTphraselookup(Nlppp*,NODE*,_TCHAR*,_TCHAR*,_TCHAR*,RFASem*);   // 12/16/14 AM.

	static bool DICTphraselookup(Nlppp*,RFASem*,RFASem*,_TCHAR*,_TCHAR*,long long);    // 12/16/14 AM.
	static bool DICTphraselookup(Nlppp*,RFASem*,_TCHAR*,RFASem*,_TCHAR*,long long);    // 12/16/14 AM.
	static bool DICTphraselookup(Nlppp*,RFASem*,_TCHAR*,_TCHAR*,RFASem*,long long);    // 12/16/14 AM.
	static bool DICTphraselookup(Nlppp*,RFASem*,_TCHAR*,_TCHAR*,_TCHAR*,RFASem*); // 12/16/14 AM.
	static bool DICTphraselookup(Nlppp*,NODE*,RFASem*,RFASem*,_TCHAR*,long long);      // 12/16/14 AM.
	static bool DICTphraselookup(Nlppp*,NODE*,RFASem*,_TCHAR*,RFASem*,long long);      // 12/16/14 AM.
	static bool DICTphraselookup(Nlppp*,NODE*,RFASem*,_TCHAR*,_TCHAR*,RFASem*);   // 12/16/14 AM.
	static bool DICTphraselookup(Nlppp*,NODE*,_TCHAR*,RFASem*,RFASem*,long long);      // 12/16/14 AM.
	...
	static bool DICTphraselookup(Nlppp*,RFASem*,RFASem*,RFASem*,_TCHAR*,long long);    // 12/16/14 AM.
	static bool DICTphraselookup(Nlppp*,RFASem*,RFASem*,_TCHAR*,RFASem*,long long);    // 12/16/14 AM.
	static bool DICTphraselookup(Nlppp*,RFASem*,RFASem*,_TCHAR*,_TCHAR*,RFASem*); // 12/16/14 AM.
	static bool DICTphraselookup(Nlppp*,RFASem*,_TCHAR*,RFASem*,RFASem*,long long);    // 12/16/14 AM.
	...
	static bool DICTphraselookup(Nlppp*,NODE*,RFASem*,RFASem*,RFASem*,long long);      // 12/16/14 AM.
	...
	static bool DICTphraselookup(Nlppp*,RFASem*,RFASem*,RFASem*,RFASem*,long long);    // 12/16/14 AM.
